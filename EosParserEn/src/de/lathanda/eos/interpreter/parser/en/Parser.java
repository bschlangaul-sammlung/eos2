...
import de.lathanda.eos.baseparser.Arguments;
import de.lathanda.eos.baseparser.Assignment;
import de.lathanda.eos.baseparser.Breakpoint;
import de.lathanda.eos.baseparser.Constant;
import de.lathanda.eos.baseparser.Declaration;
import de.lathanda.eos.baseparser.DoWhile;
import de.lathanda.eos.baseparser.Expression;
import de.lathanda.eos.baseparser.IfElse;
import de.lathanda.eos.baseparser.Invoke;
...
import de.lathanda.eos.baseparser.PropertyRead;
import de.lathanda.eos.baseparser.PropertyWrite;
import de.lathanda.eos.baseparser.RepeatForever;
import de.lathanda.eos.baseparser.RepeatTimes;
import de.lathanda.eos.baseparser.Sequence;
import de.lathanda.eos.baseparser.Stoppoint;
import de.lathanda.eos.baseparser.SubRoutine;
import de.lathanda.eos.baseparser.Type;
import de.lathanda.eos.baseparser.UserClass;
import de.lathanda.eos.baseparser.WhileDo;
import de.lathanda.eos.baseparser.With;
...
{if ("" != null) return new Constant(Boolean.FALSE, Type.getBoolean(), "false");}
  ...
  final public Constant Color() throws ParseException {MutableColor c;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case YELLOW:{
      jj_consume_token(YELLOW);
c = MutableColor.YELLOW;
      break;
      }
    case RED:{
...
c = MutableColor.WHITE;
      break;
      }
    case BLACK:{
      jj_consume_token(BLACK);
c = MutableColor.BLACK;
      break;
      }
    case BROWN:{
      jj_consume_token(BROWN);
c = MutableColor.BROWN;
      break;
      }
    case LIGHT_BLUE:{
      jj_consume_token(LIGHT_BLUE);
c = MutableColor.LIGHT_BLUE;
      break;
      }
    case LIGHT_GREEN:{
      jj_consume_token(LIGHT_GREEN);
c = MutableColor.LIGHT_GREEN;
      break;
      }
    case GRAY:{
