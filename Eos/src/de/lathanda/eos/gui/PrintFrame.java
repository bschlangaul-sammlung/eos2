...
public class PrintFrame extends JFrame {
	...
	private void initComponents(String title) {
		...
		btnLeft = GuiToolkit.createButton(LEFT, null, evt -> btnLeftActionPerformed(evt));

		left.add(btnLeft);

		btnRight = GuiToolkit.createButton(RIGHT, null, evt -> btnRightActionPerformed(evt));
		...
		btnPrint = GuiToolkit.createButton(PRINTER, null, evt -> btnPrintActionPerformed(evt));
