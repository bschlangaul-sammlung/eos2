...
import de.lathanda.eos.base.util.ErrorLevel;
import de.lathanda.eos.base.util.MessageHandler;
import de.lathanda.eos.base.util.MessageHandler.LogListener;
 ...
 * @since 0.4
 */
public class SourceCode extends DefaultStyledDocument implements Source, CompilerListener, DebugListener, LogListener,
		GuiConfigurationListener, CleanupListener, DocumentListener {
	...
	public SourceCode() {
		...
		msgHandler.addLogListener(this);
	...
	private void handleException(Exception e) {
		...
		message.println(Messages.formatError("Error.Report", ((codeRange != null) ? codeRange.getBeginLine() : "?"),
