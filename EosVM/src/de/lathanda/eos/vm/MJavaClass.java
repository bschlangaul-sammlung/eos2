...
public class MJavaClass implements MType {
	public final static MType BASE = new MJavaClass("base", Object.class, () -> {
		return null;
	});
	...
	public MJavaClass(String id, Class<?> cls, ObjectSource objSrc) {
		this.cls = cls;
		this.objSrc = objSrc;
		this.id = id;
	}
	...
	@Override
	public TreeMap<String, Variable> createProperties(Machine m) {
		return new TreeMap<>();
	}
